...
//3) Find Index of the maximum value is the maximum repeating element (index of 29 is 3).
//4) If we want to get the original array back, we can iterate 
//through the array one more time and do arr[i] = arr[i] % k where i varies from 0 to n-1.
