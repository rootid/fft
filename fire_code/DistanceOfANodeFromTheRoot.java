...
// value of a TreeNode present in the tree, write a method - pathLengthFromRoot
// that returns the distance between the root and that node. You can assume that
...
public class DistanceOfANodeFromTheRoot {
  ...
  if (root.data == n1 || (ht = pathLengthFromRoot(root.left, n1)) > 0 ||
