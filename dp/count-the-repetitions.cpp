...
//############################################## Brute force  ############################################
//1. How do we know "string s2 can be obtained from string s1"? Easy, use two
//pointers iterate through s2 and s1. If chars are equal, move both. Otherwise
//only move pointer1.
//2. We repeat step 1 and go through s1 for n1 times and count how many times
//can we go through s2.
...
//
//And, each time we append s1 to the remain string, to make a sequence: (Using
//[] to mark the remain string)
