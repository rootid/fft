...
//The problem is similar to longest substring with most K distinct characte.
//But this time, the constraint is we can only have most K characters that is
//different with the most frequent character in the substring. For example in
//the sliding window:
//
...
//Since we only have 26 characters, keep the count in a integer array is good
//enough.
//####################
