...
//of that column. Because the state of row0 and the state of column0 would occupy the same cell, I
//let it be the state of row0,
//and use another variable "col0" for column0. In the first phase, use matrix elements to set states
