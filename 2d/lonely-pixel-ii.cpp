...
//N, find the number of
//black pixels located at some specific row R and column C that align with all
//the following rules:
...
//If you find one, add N for each of its black columns that doesn't have extra
//black pixels (in
//other rows)
