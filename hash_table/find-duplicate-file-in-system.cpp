...
//The subtle issue is that string object is copied multiple times which makes it 10 time slower than optimal one according to leetcode submission result. It may be better to use string_view, but it's in C++ 17 standard. 
