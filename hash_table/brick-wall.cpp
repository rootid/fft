...
//#############################################################################
//The max number of bricks to cross =  the number of rows, whenever we see a
//edge, the number of crossed bricks reduce by 1. Thus we just need keep track
//of the location where we see maximum number of edges.
