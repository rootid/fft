...
//After removing some edge from parent to child, (where the child cannot be the
//original root) the subtree rooted at child must be half the sum of the entire
//tree.
//Let's record the sum of every subtree. We can do this recursively using
//depth-first search. After, we should check that half the sum of the entire
//tree occurs somewhere in our recording (and not from the total of the entire
//tree.)
//Our careful treatment and analysis above prevented errors in the case of
//these trees:
//
//  0
// / \
...
//[0,-1,1], which many solutions dismiss. I think this test case should be
//added.
