...
//################################## Caching(last number and the peeked-flag) ##################################
...
class PeekingIterator : public Iterator {
  ...
  public:
    ...
    //From problem stmt : it essentially peek() at the element that will be returned by the next call to next().
    int peek() {
      if (!hasPeeked) {
        num = Iterator::next();
        hasPeeked = true;
