...
//like that in the replacement string. For example, "leetcode".replaceAll("(.)(.)", "$2$1") 
//finds pairs of characters and switches their order, resulting in the string "elteoced". Group zero is just the whole match.
