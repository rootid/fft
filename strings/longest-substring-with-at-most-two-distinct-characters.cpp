...
//same category as those such as "longest substring without repeating
//characters",
//"minimum window substring", and "substring with concatenation of all words".
//To solve this kind of question we can use two pointers and a hash table. When
//the key of the hash table is char, we can simply use an array as the hash
//table. The most important idea in solving this kind of questions is "how to
//update the "start" pointer" and the solution to these questions seem usually
//differ only in this respect.
