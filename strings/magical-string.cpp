...
//The first few elements of string S is the following: S = "122 112 122 122 112112 2……"
...
int magicalString(int n) { 
  ...
  int i = 2;
  while (str.size() < n) {
      str += string(s[i++] - '0', s.back() ^ 3); 
      //XOR : And 49^3 is 50 and 50^3 is 49
  }
  return count(S.begin(), S.begin() + n, '1'); //count total number of 1's
}
