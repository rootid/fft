...
//############################################# pytonic #############################################
//Going through all permutations of the digits, returning the first one that's
//larger than the input (unless it's out of range). Pretty inefficient but gets
//accepted in about 200 ms...
...
//
//The worst case is n = 1111111111, because I go through all 10! permutations
//and each one gets fully compared. This case takes about 600 ms.
