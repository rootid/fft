...
//priority queue - sorted by start time, and for same start time sort by either
//largest end time or smallest (it is not matter).
//Everytime you poll from priority queue, just make sure it doesn’t intersect
