...
//So for each bit, we just need to count the total number of 1s, then the total
//number of 0s will be (total numbers - the numbers of 1s).
//And the contribution to the Hamming distance will be count of 1s times the
//count of 0s. Similar argument can be applied to all the rest bits.
